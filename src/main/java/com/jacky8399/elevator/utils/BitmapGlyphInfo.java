 ...
 * <br>
 * <a href="https://github.com/Owen1212055/mc-fonts/blob/main/fonts/minecraft_include_unifont.json">The better version</a>
 * is much larger and requires extra processing, so this should be good enough
 */
@SuppressWarnings("unused")
public enum BitmapGlyphInfo {
  DEFAULT(' ', 9), // to better accommodate CJK characters
  UNICODE_0020(' ', 3),
  UNICODE_0021('!', 1),
  UNICODE_0022('"', 3),
  UNICODE_0023('#', 5),
